...
class SuccessfullySignUpModalWindow extends StatelessWidget {
  const SuccessfullySignUpModalWindow({super.key});
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      "Ваш обліковий запис успішно зареєстрований",
                  ...
                  Padding(
                    ...
                    child: Text(
                      "Тепер Ви можете користуватися будь-якими сервісами мобільного додатку",
                      textAlign: TextAlign.center,
                      style: GoogleFonts.roboto(
                        fontSize: 16.0.sp,
                        fontWeight: FontWeight.w400,
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      onTap: () {
                        Provider.of<InputCodeScreenController>(context,
                                listen: false)
